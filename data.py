...
# Comma, period , question mark & exclamation mark only:
PUNCTUATION_VOCABULARY = {SPACE, ",COMMA", "।PERIOD", "?QUESTIONMARK", "!EXCLAMATIONMARK"}
PUNCTUATION_MAPPING = {":COLON": ",COMMA", ";SEMICOLON": "।PERIOD", "-DASH": ",COMMA"}
